...
public class PhotoActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_photo_4m);

		photo_relativeLayout = (RelativeLayout) findViewById(R.id.photo_relativeLayout_4m);
		...
		Button photo_bt_exit = (Button) findViewById(R.id.photo_bt_exit_4m);
		...
		Button photo_bt_del = (Button) findViewById(R.id.photo_bt_del_4m);
		...
		Button photo_bt_enter = (Button) findViewById(R.id.photo_bt_enter_4m);
		...
		pager = (ViewPager) findViewById(R.id.viewpager_4m);
